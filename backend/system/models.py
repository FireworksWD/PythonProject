...
class Users(AbstractUser, CoreModel):
    ...
    avatars = models.TextField(verbose_name="普通用户头像", null=True, blank=True, help_text="头像",default='images/customer.png')
    ...
    address = models.CharField(max_length=150, blank=True, null=True, verbose_name='地址')
    balance = models.DecimalField(max_digits=10, decimal_places=2, verbose_name='余额',default='0.00')
